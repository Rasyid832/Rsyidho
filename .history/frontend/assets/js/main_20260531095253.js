...
// =========================================================================
// FUNGSI UTAMA PARSER: Matematika, Markdown Bold, & Code Block (Prism.js)
// =========================================================================
function parseAndRenderMath(text) {
    ...
    // 6. Render Format Markdown Tebal (Bold) **teks** - FIXED (Baris ganda penyebab bug tanda kurung dihapus)
