...
async function sendChatMessage() {
    ...
    try {
        ...
        if (isResponseImage) {
            ...
            // [MULTICHAT] Simpan respon gambar ke history room
            ...
            function typeWriterEffect() {
                if (isAbortedDuringTyping) {
                    ...
                    // [MULTICHAT] Simpan teks parsial jika di-stop
                ...
                if (currentTextIndex <= rawContent.length) {
                    ...
                    // [MULTICHAT] Simpan respon lengkap setelah selesai mengetik
