...
// =========================================================================
// FUNGSI SAKTI: Custom Parser Matematika untuk Memaksa KaTeX Jalan 100%
// =========================================================================
function parseAndRenderMath(text) {
    if (!window.katex) return text;

    // 1. Handle Display Math ($$...$$) terlebih dahulu
...
async function sendChatMessage() {
    ...
    try {
        ...
        // --- PROSES PARSING MENGGUNAKAN FUNGSI CUSTOM PARSER SAKTI ---
