...
function handleFileSelection() {
    ...
    reader.onload = function (e) {
        // Ambil string murni base64 setelah tanda koma (data:image/png;base64,xxxxxx)
...
function clearSelectedFile() {
    ...
    document.getElementById('file-preview-container').classAdd = document.getElementById('file-preview-container').classList.add('hidden');
...
async function sendChatMessage() {
    ...
    if (selectedFileName) {
        ...
        attachmentHtml = `
            <div class="flex items-center gap-1.5 text-xs bg-purple-700/50 border border-purple-400/30 px-2 py-1 rounded-lg mb-1.5 font-medium text-purple-200">
    ...
    try {
        ...
        // Render JAWABAN ASLI dari AI (Kiri)
        const aiMessageHtml = `
        ...
        alert("Gagal memproses file. Pastikan server backend kamu menyala dan ukuran file tidak terlalu raksasa, bro!");
    }
}